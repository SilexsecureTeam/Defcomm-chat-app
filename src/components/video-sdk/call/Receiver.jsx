...
const Receiver = ({ participant }) => {
  ...
  return (
    <figure className="w-full h-full relative bg-black/80 rounded-[10px] flex justify-center items-center">
      ...
      <div
        className={`absolute cursor-pointer hover:scale-105 duration-100 flex items-center justify-center left-2 bottom-2 text-white ${
      ...
      {callType == "video" && (
        <div
          className={`absolute cursor-pointer hover:scale-105 duration-100 flex items-center justify-center right-2 bottom-2 text-white ${
